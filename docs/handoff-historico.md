# 🗄️ Handoff histórico — G-Prompt Studio (sesiones 6-19)

> **ARCHIVO.** Este documento conserva el detalle round-a-round de las
> sesiones 6 a 19. El estado vigente y los pendientes vivos están en
> [`HANDOFF.md`](../HANDOFF.md) en la raíz. Aquí solo se consulta el
> "por qué" histórico de una decisión concreta. No se actualiza.
