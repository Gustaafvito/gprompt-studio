...
AVATAR_ANGLES = {
    ...
    "face_front": {
        ...
        "prompt": "close-up portrait, face perfectly centered, looking directly at camera, front view",
    ...
    "face_34_left": {
        ...
        "prompt": "close-up portrait, head turned three-quarter view to the left, three-quarter angle",
    ...
    "face_34_right": {
        ...
        "prompt": "close-up portrait, head turned three-quarter view to the right, three-quarter angle",
    ...
    "face_profile_left": {
        ...
        "prompt": "close-up portrait, full left side profile, head in complete profile view facing left",
    ...
    "face_profile_right": {
        ...
        "prompt": "close-up portrait, full right side profile, head in complete profile view facing right",
    ...
    "bust_front": {
        "label": "Busto — frontal",
        "prompt": "upper body shot from chest up, facing camera directly, front view",
    ...
    "bust_34_left": {
        ...
        "prompt": "upper body shot from chest up, body turned three-quarter to the left",
    ...
    "bust_34_right": {
        ...
        "prompt": "upper body shot from chest up, body turned three-quarter to the right",
    ...
    "low_angle": {
        ...
        "prompt": "upper body shot from a low camera angle looking up at the subject",
    ...
    "high_angle": {
        ...
        "prompt": "upper body shot from a high camera angle looking down at the subject",
    ...
    "expression_smile": {
        ...
        "prompt": "close-up portrait, front view, warm genuine smile, joyful expression",
    ...
    "expression_serious": {
        ...
        "prompt": "close-up portrait, front view, serious neutral expression, calm look",
