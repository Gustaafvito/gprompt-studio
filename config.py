...
PROMPT_TEMPLATES = {
    ...
    "fotorrealismo_sd": {
        "modelos": ["Z Image Turbo", "Z-Image-Base", "CyberRealistic", "Realistic Vision V6.0 B1", "Juggernaut XL", "DreamShaper", "DreamShaper XL", "Illustrious Realism by Klaabu", "Real Dream SDXL", "MajicMIX Realistic v6", "Prodigies"],
    ...
    "retrato_sd": {
        "modelos": ["Z Image Turbo", "Z-Image-Base", "CyberRealistic", "Realistic Vision V6.0 B1", "Prodigies", "MajicMIX Realistic v6"],
